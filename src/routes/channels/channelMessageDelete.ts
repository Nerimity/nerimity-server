...
async function route (req: Request, res: Response) {
  ...
  const isMessageDeleted = await deleteMessage({channelId: req.channelCache._id ,messageId, serverId: req.channelCache.server?._id, recipientIds: req.channelCache.recipients});
